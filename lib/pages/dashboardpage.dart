                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Nuestros Servicios',
                                style:
                                    GoogleFonts.andika(fontSize: 40, fontWeight: FontWeight.bold),
                                textAlign: TextAlign.center,
                              ),
                              Text(
                                'Construimos tu necesidad en cualquier ambiente tecnologico (Aplicaciones móviles para Android y iOS, aplicaciones de escritorio y web).',
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Tu servicio tambien puede estar replicado en la web, para que tengas un mayor control de administracion o preferencias de usuario.',
                              style: GoogleFonts.andika(fontSize: 20),
                            ),
                          ],
                        ),
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Te ofrecemos aplicaciones de escritorio tanto para entornos de sistemas operativos Windows, Mac y Linux.',
                              style: GoogleFonts.andika(fontSize: 20),
                            ),
                          ],
                        ),
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Image.asset(
                              'assets/mac-os-logo.png',
                              width: 200,
                            ),
                            Flexible(
                                child: Image.asset(
                              'assets/linux-logo.png',
                              width: 100,
                            )),
                          ],
                        ),
